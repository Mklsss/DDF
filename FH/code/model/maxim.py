...
class MAXIM_dns_3s(nn.Module):  # input shape: n, c, h, w
    ...
    def __init__(self, features=16, depth=3, use_bias=True, num_supervision_scales=int(3), lrelu_slope=0.2,
        ...
        # depth=0
        self.stage_0_input_conv_0 = nn.Conv2d(1, self.features, kernel_size=(3, 3), bias=self.bias, padding=1)
        ...
        # depth=1
        self.stage_0_input_conv_1 = nn.Conv2d(1, 2 * self.features, kernel_size=(3, 3), bias=self.bias, padding=1)
        self.stage_0_encoder_block_1 = UNetEncoderBlock(cin=3 * self.features, num_channels=2 * self.features,
                                                        ...
                                                        downsample=True, use_global_mlp=self.use_global_mlp)
        # depth=2
        self.stage_0_input_conv_2 = nn.Conv2d(1, 4 * self.features, kernel_size=(3, 3), bias=self.bias, padding=1)
        ...
        # multi scale input and encoder
        # depth=0
        self.stage_1_input_conv_0 = nn.Conv2d(1, self.features, kernel_size=(3, 3), bias=self.bias, padding=1)
        ...
        self.stage_1_encoder_block_0 = UNetEncoderBlock(cin=2 * self.features, num_channels=self.features,
                                                        ...
                                                        downsample=True, use_global_mlp=self.use_global_mlp)
        # depth=1
        self.stage_1_input_conv_1 = nn.Conv2d(1, 2 * self.features, kernel_size=(3, 3), bias=self.bias, padding=1)
        ...
        self.stage_1_encoder_block_1 = UNetEncoderBlock(cin=3 * self.features, num_channels=2 * self.features,
                                                        ...
                                                        downsample=True, use_global_mlp=self.use_global_mlp)
        # depth=2
        self.stage_1_input_conv_2 = nn.Conv2d(1, 4 * self.features, kernel_size=(3, 3), bias=self.bias, padding=1)
...
#         # multi scale input and encoder
#         # depth=0
#         self.stage_2_input_conv_0 = nn.Conv2d(1, self.features, kernel_size=(3, 3), bias=self.bias, padding=1)
...
#                                                         downsample=True, use_global_mlp=self.use_global_mlp)
#         # depth=1
#         self.stage_2_input_conv_1 = nn.Conv2d(1, 2 * self.features, kernel_size=(3, 3), bias=self.bias, padding=1)
...
#                                                         downsample=True, use_global_mlp=self.use_global_mlp)
#         # depth=2
#         self.stage_2_input_conv_2 = nn.Conv2d(1, 4 * self.features, kernel_size=(3, 3), bias=self.bias, padding=1)
