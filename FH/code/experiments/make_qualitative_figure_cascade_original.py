...
input_root = Path("fig/qualitative_raw_no_overlap_cascade_original/sample_000")
output_pdf = Path("fig/qualitative_results_cascade_original.pdf")
output_png = Path("fig/qualitative_results_cascade_original.png")
